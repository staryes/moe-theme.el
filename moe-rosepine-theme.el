;;; moe-rosepine-theme.el --- An eye-candy theme for Emacser

;; Copyright (C) 2023 lilyuri
...
(let ((class '((class color) (min-colors 89)))
      ...
      (rosepine-text       "#e0def4")  ;; foreground
      (rosepine-base       "#191724")  ;; background
      (rosepine-high       "#6e6a86")  ;; highlight
      (rosepine-gold       "#f6c177")  ;; critical
      (rosepine-iris       "#c4a7e7")  ;; salient
      (rosepine-surface    "#555169")  ;; strong
      (rosepine-love       "#eb6f92")  ;; popout
      (rosepine-subtle     "#6e6a86")  ;; subtle
      (rosepine-faded      "#cecaed")  ;; faded
      (rosepine-cursor     "#e0def4")  ;; cursor
      )
  ;; Customize color
  (defconst -moe-rosepine-bg                         rosepine-base)
  (defconst -moe-rosepine-fg                         rosepine-text)
  (defconst -moe-rosepine-builtin                    rosepine-iris)
  (defconst -moe-rosepine-comment-delimiter          rosepine-faded)
  (defconst -moe-rosepine-comment                    rosepine-faded)
  (defconst -moe-rosepine-constant                   rosepine-iris)
  (defconst -moe-rosepine-doc                        rosepine-faded)
  (defconst -moe-rosepine-doc-string                 rosepine-faded)
  (defconst -moe-rosepine-function-name              rosepine-surface)
  (defconst -moe-rosepine-keyword                    rosepine-iris)
  (defconst -moe-rosepine-negation-char              rosepine-love)
  (defconst -moe-rosepine-preprocessor               rosepine-surface)
  (defconst -moe-rosepine-regexp-grouping-backslash  rosepine-surface)
  (defconst -moe-rosepine-regexp-grouping-construct  rosepine-subtle)
  (defconst -moe-rosepine-string                     rosepine-love)
  (defconst -moe-rosepine-type                       rosepine-iris)
  (defconst -moe-rosepine-variable-name              rosepine-surface)
  (defconst -moe-rosepine-warning                    rosepine-gold)

  (defvar moe-rosepine-bg                         -moe-rosepine-bg                       )
  (defvar moe-rosepine-fg                         -moe-rosepine-fg                       )
  (defvar moe-rosepine-builtin                    -moe-rosepine-builtin                  )
  (defvar moe-rosepine-comment-delimiter          -moe-rosepine-comment-delimiter        )
  (defvar moe-rosepine-comment                    -moe-rosepine-comment                  )
  (defvar moe-rosepine-constant                   -moe-rosepine-constant                 )
  (defvar moe-rosepine-doc                        -moe-rosepine-doc                      )
  (defvar moe-rosepine-doc-string                 -moe-rosepine-doc-string               )
  (defvar moe-rosepine-function-name              -moe-rosepine-function-name            )
  (defvar moe-rosepine-keyword                    -moe-rosepine-keyword                  )
  (defvar moe-rosepine-negation-char              -moe-rosepine-negation-char            )
  (defvar moe-rosepine-preprocessor               -moe-rosepine-preprocessor             )
  (defvar moe-rosepine-regexp-grouping-backslash  -moe-rosepine-regexp-grouping-backslash)
  (defvar moe-rosepine-regexp-grouping-construct  -moe-rosepine-regexp-grouping-construct)
  (defvar moe-rosepine-string                     -moe-rosepine-string                   )
  (defvar moe-rosepine-type                       -moe-rosepine-type                     )
  (defvar moe-rosepine-variable-name              -moe-rosepine-variable-name            )
  (defvar moe-rosepine-warning                    -moe-rosepine-warning                  )

  (custom-theme-set-faces
   'moe-rosepine
   ;; Font lock faces
   `(font-lock-builtin-face              ((,class (:background unspecified :foreground ,moe-rosepine-builtin                  ))))
   `(font-lock-comment-delimiter-face    ((,class (:background unspecified :foreground ,moe-rosepine-comment-delimiter        :slant italic))))
   `(font-lock-comment-face              ((,class (:background unspecified :foreground ,moe-rosepine-comment                  :slant italic))))
   `(font-lock-constant-face             ((,class (:background unspecified :foreground ,moe-rosepine-constant                 ))))
   `(font-lock-doc-face                  ((,class (:background unspecified :foreground ,moe-rosepine-doc                      ))))
   `(font-lock-doc-string-face           ((,class (:background unspecified :foreground ,moe-rosepine-doc-string               ))))
   `(font-lock-function-name-face        ((,class (:background unspecified :foreground ,moe-rosepine-function-name            ))))
   `(font-lock-keyword-face              ((,class (:background unspecified :foreground ,moe-rosepine-keyword                  ))))
   `(font-lock-negation-char-face        ((,class (:background unspecified :foreground ,moe-rosepine-negation-char            ))))
   `(font-lock-preprocessor-face         ((,class (:background unspecified :foreground ,moe-rosepine-preprocessor             ))))
   `(font-lock-regexp-grouping-backslash ((,class (:background unspecified :foreground ,moe-rosepine-regexp-grouping-backslash))))
   `(font-lock-regexp-grouping-construct ((,class (:background unspecified :foreground ,moe-rosepine-regexp-grouping-construct))))
   `(font-lock-string-face               ((,class (:background unspecified :foreground ,moe-rosepine-string                   ))))
   `(font-lock-type-face                 ((,class (:background unspecified :foreground ,moe-rosepine-type                     ))))
   `(font-lock-variable-name-face        ((,class (:background unspecified :foreground ,moe-rosepine-variable-name            ))))
   `(font-lock-warning-face              ((,class (:background unspecified :foreground ,moe-rosepine-warning               :weight bold ))))
   ;; Ensure sufficient contrast on low-color terminals.
   `(default ((((class color) (min-colors 4096)) (:foreground ,moe-rosepine-fg :background ,moe-rosepine-bg))
	      (((class color) (min-colors 256)) (:foreground ,moe-rosepine-fg :background ,moe-rosepine-bg))
	      (,class (:foreground ,moe-rosepine-fg :background ,moe-rosepine-bg))))
...
(provide-theme 'moe-rosepine)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; moe-rosepine-theme.el ends here
